...
export default function ArtisanBillsTable({ artisanBills, onToggleStatus, onViewPdf, onEdit, onDelete, onSettle, onEditSettlement, onDeleteSettlement }) {
  const [expandedBillIds, setExpandedBillIds] = useState(new Set());

  if (artisanBills.length === 0) {
    return null;
  }
